...
const findUserByProviderId = (provider, providerId, callback) => {
...
const createUser = (provider, profile, callback) => {
...
module.exports = { findUserByProviderId, findUserById, createUser };